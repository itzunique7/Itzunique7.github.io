/*=============================
    Made With ♥ By dhiraj7867
  ============================*/
// Start Code
// 08 June 2024
// dhiraj7867 | https://dhiraj7867github.io
...
calcBtn.addEventListener("click", function (e) {
  ...
  //lovescore conditions
    ...
    loveInfo.innerHTML =
      ...
      capitalize_Words(theirName.value) +
      "</b>" +
      " love each other like Pen & book. There is no fake things in your love. Go Ahead!";
    ...
    loveInfo.innerHTML =
      ...
      capitalize_Words(theirName.value) +
      "</b>" +
      " love each other like Krishna and radha. You should get married with " +
      "<b>" +
      capitalize_Words(theirName.value) +
      "</b>" +
